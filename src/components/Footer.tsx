        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <ul role="list" className="space-y-2">
              <li>
                <a href="mailto:info@switchphone.com" className="text-sm text-gray-300 hover:text-white">
                  info@switchphone.com
                </a>
              </li>
              <li>
                <a href="tel:+1234567890" className="text-sm text-gray-300 hover:text-white">
                  +1 (234) 567-890
                </a>
              </li>
            </ul>
